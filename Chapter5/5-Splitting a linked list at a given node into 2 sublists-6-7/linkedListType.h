...
class linkedListType
{
    public:
        ...
        int returnBack();
        //divide list into 2 sublists with almost the same size
        void divideMid(linkedListType &sublist);
        ///a
        //this will divide the list at specific location and start the second list at this location
        virtual void divideAt(linkedListType &secondList,const int &item)=0;
